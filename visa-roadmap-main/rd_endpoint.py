...
def multiturn_generate_content(input_text):
  ...
  response = model.generate_content(contents=[system_prompt,input_text],generation_config=generation_config,stream=True)
  return response
...
# Test the function
#input_text = "Provide client details here."
